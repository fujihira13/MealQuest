...
- Monthly statistics with a pie chart, a per-week expense table (5 buckets per month: 1-7/8-14/15-21/22-28/29-end; each row shows its date range and is status-flagged as ended/current/upcoming; ended rows show remaining/over-budget in green/red text — no checkmarks), and budget gauges
