...
2. **リファレンス実装の参照** — 新規制作時は、過去のあきらパパ様承認済み実装を必ず参照する。ゼロから書き直さない。承認済みリファレンス: `~/workspace/Codex-video-1/src/ClaudeCodeInstall.tsx`
